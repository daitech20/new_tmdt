                ...
                <a-layout-content style="padding: 0 50px">
                    ...
                    >
                        ...
                        <a-form-item
                            ...
                            label="Active"
                        >
                            <a-radio-group v-model:value="category.is_active" name="radioGroup">
...
export default({
    ...
    methods: {
        ...
        getData: function() {
            BaseRequest.get('products/category/update/' + this.$route.params.category_id)
			.then(response => {
				this.category.name = response.data.name
                this.category.description = response.data.description
                this.category.is_active = response.data.is_active
        ...
        onFinish: function() {
            BaseRequest.put('products/category/update/' + this.$route.params.category_id, {
            ...
            .catch(error=> {
                this.errors = error.response.data
                if (this.errors.name) {
                    this.errorsNotification("Update category thất bại", this.errors.name[0])
                }
                else {
                    this.errorsNotification("Update category thất bại", "")
                }
