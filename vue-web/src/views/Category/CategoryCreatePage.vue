    ...
    <a-layout v-if="isLoggedIn" style="min-height: 100vh">
		...
		<a-layout>
            ...
            <a-layout>
                ...
                title="Thêm category"
                sub-title="This is a subtitle of create category page" />
    ...
    methods: {
        ...
        onFinish: function() {
            ...
            .catch(error=> {
                this.errors = error.response.data
                if (this.errors.name) {
                    this.errorsNotification("Thêm category thất bại", this.errors.name[0])
                }
                else {
                    this.errorsNotification("Thêm category thất bại", "")
                }
